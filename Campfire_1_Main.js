...
/*
*s Cameras Camera 1 Position Pan: -39
*s Cameras Camera 1 Position Roll: 0
*s Cameras Camera 1 Position Tilt: -492
*s Cameras Camera 1 Position Zoom: 8210
*/

const mutedOverviewPTZPosition = {
  Pan: -39,
  Tilt: -492,
  Zoom: 8210
}
...
async function runMuteState() {
  ...
  updateCameraMode('Off', 'Microphones Muted');
